...
- Exact-key matches: 240; fuzzy-only matches: 106
- Date agreement (matched pairs, both dated): 267/346 (77.2%)
- Content-type agreement (type-blind matches): 342/342 (100.0%)
- Missed Willis rows: 42
- Surplus model rows on Willis-covered pages (review list, NOT false positives -- Willis is partial even within these pages): 96
...
| 52 | Poynton v Stockport Great Moor | Poynton v Great Moor | 0.8 |
...
| 57 | Stockport 2nd XI v Cheadle Hulme 2nd XI | Stockport And Cheadle Hulme Second | 0.835 |
...
| 39 | W Pearce's (Wycombe) XI v Southall | Mr W Pearce's Wycombe XI v Southall | 0.925 |
