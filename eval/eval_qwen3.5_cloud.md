...
- **Willis coverage (recall): 341/388 (87.9%)**
- Exact-key matches: 242; fuzzy-only matches: 99
- Date agreement (matched pairs, both dated): 227/331 (68.6%)
- Content-type agreement (type-blind matches): 343/343 (100.0%)
- Pages-count agreement (matched pairs -- does the model flag the same number of pages this entry spans as Willis does): 299/341 (87.7%)
- Missed Willis rows: 47
- Surplus model rows on Willis-covered pages (review list, NOT false positives -- Willis is partial even within these pages): 118
...
| 38 | Wycombe Bells v Wanderers V Holloway's Boot Operatives O C | 18950824 | match information |
...
| 55 | Bebington Bible Class v St John's Second XI | 18950824 | match information |
