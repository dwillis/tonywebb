# Evaluation: reconciled_glm vs Willis ground truth

Willis pages covered: 56 (pages 1-61; no claim made about pages outside this range)

- **Willis coverage (recall): 355/388 (91.5%)**
- Exact-key matches: 294; fuzzy-only matches: 61
- Date agreement (matched pairs, both dated): 302/355 (85.1%)
- Content-type agreement (type-blind matches): 356/357 (99.7%)
- Pages-count agreement (matched pairs -- does the model flag the same number of pages this entry spans as Willis does): 281/355 (79.2%)
- Missed Willis rows: 33
- Surplus model rows on Willis-covered pages (review list, NOT false positives -- Willis is partial even within these pages): 77
...
| 59 | Birkenhead Park A player statistics | Birkenhead Victoria XI player statistics | 0.827 |
...
| 40 | Sutton v Haddenham | Sutton XI v Haddenham XII | 0.837 |
| 40 | Married v Single | Married XI v Single XI | 0.842 |
...
| 54 | Mr Wynne's XI v Mr Griffith's XI | W Wynne's XI v W Griffith's XI | 0.897 |
...
| 4 | Haviland XI v Luton Villa-Road | 18950803 | match information |
...
| 54 | The Park v Ormskirk | 18950817 | match information |
...
| 55 | All Saints' v Wesley | 18950817 | match information |
...
| 61 | Birkenhead Park player statistics | 18950900 | statistics |
| 61 | Birkenhead Victoria player statistics | 18950900 | statistics |
...
| 61 | Oxton player statistics | 18950900 | statistics |
| 61 | Rock Ferry player statistics | 18950900 | statistics |
