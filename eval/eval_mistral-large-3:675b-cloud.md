...
- Exact-key matches: 238; fuzzy-only matches: 98
- Date agreement (matched pairs, both dated): 243/336 (72.3%)
...
- Surplus model rows on Willis-covered pages (review list, NOT false positives -- Willis is partial even within these pages): 143
...
|---|---:|---:|---:|
| biography | 1 | 1 | 100.0% |
| match information | 301 | 350 | 86.0% |
...
| 41 | Histon And Impington v Old Higher Grade | 18950000 | match information |
